...
- Streamlit ��ú���: `streamlit run scripts/lock_dashboard_streamlit.py`�� �� UI���� ��ݰ� �浹�� �����մϴ�.
- Preflight Ȯ��: `python scripts/preflight_checks.py --extra "tests/test_session_ecosystem.py"` ������ ������Ʈ�� ������ �߰��ϰ�, `--skip-handoff`/`--only-handoff` �ɼ����� ��Ȳ�� ���� ������ �����մϴ�.
