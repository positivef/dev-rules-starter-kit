...
1. python scripts/multi_agent_sync.py list·Î ÇöÀç ÄÚµğ³×ÀÌ¼Ç »óÅÂ È®ÀÎ
2. python scripts/agent_sync_status.py / --agent ¡¦ --files ¡¦·Î Àá±İ Ãæµ¹ ¿©ºÎ ¼±Á¡
3. YAML °è¾à¿¡ Evidence/Commands·Î ÆíÁı ÆÄÀÏÀ» ¸ğµÎ ±âÀç (TaskExecutor°¡ ÀÚµ¿ Àá±İ)
4. ½ÇÇà Àü python scripts/preflight_checks.py (ÇÊ¿ä ½Ã --quick, --only-handoff)
5. ÇÚµå¿ÀÇÁ ½Ã Àá±İ ÇØÁ¦ ¹× docs/COLLAB_LOCKING_GUIDE.md Âü°í »çÇ×À» ÇÔ²² Àü´Ş

> »ó¼¼ ÀıÂ÷¿Í Ã¼Å©¸®½ºÆ®´Â docs/COLLAB_LOCKING_GUIDE.md¿¡ Á¤¸®µÇ¾î ÀÖÀ¸¸ç, Obsidian ½ÌÅ© ½Ã ÇØ´ç ¹®¼­¸¦ °øÀ¯ÇÏ¼¼¿ä.

- ºü¸¥ Á¡°Ë: python scripts/lock_dashboard.py --agent <you> --files <paths>¸¦ »ç¿ëÇØ Àá±İ/Ãæµ¹ ÇöÈ²À» ÇÑ ¹ø¿¡ È®ÀÎÇÏ°í, ÇÊ¿ä ½Ã gent_sync_status.py¿Í º´ÇàÇÏ¼¼¿ä.

- Streamlit º¸±â: `streamlit run scripts/lock_dashboard_streamlit.py`·Î Àá±İ/Ãæµ¹ ÇöÈ²À» ½Ã°¢ÀûÀ¸·Î È®ÀÎÇÏ¼¼¿ä.
