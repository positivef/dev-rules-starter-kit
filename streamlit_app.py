...
st.warning("""
**⚠️ 이 대시보드는 시각화만 수행합니다**

검증은 다음 에이전트가 담당합니다:
- **DeepAnalyzer** (P4: SOLID, P5: 보안, P7: Hallucination)
- **TeamStatsAggregator** (P6: 품질 게이트)

대시보드는 Layer 7 (Visualization)으로, 단순히 결과를 표시할 뿐입니다.

자세한 내용: [NORTH_STAR.md](https://github.com/positivef/dev-rules-starter-kit/blob/main/NORTH_STAR.md)
""")
